...
//    }
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                ...
                .antMatchers("/authentication/login", "/authentication/registration", "/error", "/product", "/img/**", "/product/info/**", "/product/search/**", "/css/**", "/js/**",  "/user/index", "file:///" + uploadPath + "/").permitAll()
